...
class ReconTool:
    ...
    def subdomain_checker(self):
        ...
        wordlist_file = os.path.join("docs", "subdomain.txt")
...
class StrangeTool:
    ...
    def show_banner(self):
        ...
        print(banner.renderText('STRANGE TOOL'))
        print("Security Testing and Reconnaissance Assistant\n")
    ...
    def barcode_generator(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('BARCODE GEN'))
    ...
    def qrcode_generator(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('QRCODE GEN'))
    ...
    def password_generator(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('PASSWORD GEN'))
    ...
    def wordlist_generator(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('WORDLIST GEN'))
    ...
    def subdomain_checker(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('SUBDOMAIN CHECK'))
    ...
    def ddos_tool(self):
        self.clear_screen()
        print(Figlet(font='slant').renderText('DDoS TOOL'))
        ...
        threads = int(input("Enter number of threads (1-500): "))
        
        print("\nStarting simulated attack... (Press Ctrl+C to stop)")
        ...
        try:
            ...
            while time.time() - start_time < duration:
                time.sleep(1)
                print(f"\rPackets sent: {packets_sent}", end="")
